...
export default function LoginPage() {
  ...
  return <main className="app-shell"><section className="launcher-card" style={{ alignSelf: "center" }}>
    <div className="brand-row"><div className="brand-mark">SP</div><div><p className="eyebrow">SitePulse</p><h1>Pilot sign in</h1></div></div>
    <p style={{ color: "#5f6b76", lineHeight: 1.6 }}>Sign in with the email and password created for your SitePulse pilot account.</p>
