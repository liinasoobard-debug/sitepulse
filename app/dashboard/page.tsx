...
export default function DashboardPage() {
  ...
  return <main className="dashboard-page health-dashboard"><div className="dashboard-shell">
    ...
    <ProductionPerformance view={performanceView} setView={setPerformanceView} points={performancePoints} unit={data.unit} compatible={reliableQuantity&&reliableProductivity}/>
